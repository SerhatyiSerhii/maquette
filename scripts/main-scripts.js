...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createSignUp() {
        ...
        makeAppeal.querySelector('h2').textContent = 'Sign up to receive the latest updates and news'; // TODO: don't use query selector. you can store element in variable
        ...
        for (var i = 0; i < 2; i++) { // TODO: no need
        ...
        body.appendChild(makeSignUp); // TODO: originaly this section was in main
    }
    ...
    function createFooter() {
        ...
        var sMChildren = []; // TODO: fill this array with svgs.

        for (var i = 0; i < 3; i++) { // TODO: and use here its length, like you did for containerBranches and policies
            var makeListItm = document.createElement('li');
            var makeLink = document.createElement('a');
            makeLink.setAttribute('href', '#');
